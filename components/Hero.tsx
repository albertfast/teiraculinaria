...
const Hero: React.FC = () => {
  ...
  <img src={(import.meta as any).env.BASE_URL + "imggallery/146036331_2570005219790657_2835741437971567938_n.jpg"} alt="Chef background" className="absolute inset-0 w-full h-full object-cover opacity-30" />
